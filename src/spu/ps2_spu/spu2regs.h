...
#define U16_REGISTER(x)					((volatile u16 *) (0x1F900000 | (x)))
#define U32_REGISTER(x)					((volatile u32 *) (0x1F800000 | (x)))
...
#define SD_BASE_REG(reg)				((volatile u16 *)(0x1F900000 + reg))
...
#define SD_S_ADMAS(core) 				SD_BASE_REG(0x1B0 + ((core) << 10))
...
#define SD_VA_NAX_HI(core, voice)		SD_VA_REG((core), (voice), 0x08)
#define SD_VA_NAX_LO(core, voice)		SD_VA_REG((core), (voice), 0x0A)

#define SD_C_STATX(core)				((volatile u16*)(0x1F900344 + ((core) << 10))) // This is not the official name

#define SD_S_ENDX_HI(core)				((volatile u16*)(0x1F900340 + ((core) << 10)))
#define SD_S_ENDX_LO(core)				((volatile u16*)(0x1F900342 + ((core) << 10)))
...
#define SD_C_SPDIF_OUT					((volatile u16*)0x1F9007C0)
#define SD_C_IRQINFO					((volatile u16*)0x1F9007C2)
#define SD_C_SPDIF_MODE					((volatile u16*)0x1F9007C6)
#define SD_C_SPDIF_MEDIA				((volatile u16*)0x1F9007C8)
...
#define SD_DMA_ADDR(ch)					((volatile u32*)(0x1F8010C0+(ch*1088)))
#define SD_DMA_MODE(ch)					((volatile u16*)(0x1F8010C4+(ch*1088)))
#define SD_DMA_SIZE(ch)					((volatile u16*)(0x1F8010C6+(ch*1088)))
#define SD_DMA_MSIZE(ch)				((volatile u32*)(0x1F8010C4+(ch*1088)))
#define SD_DMA_CHCR(ch)					((volatile u32*)(0x1F8010C8+(ch*1088)))
// CHCR
